...
namespace OperatorsOverloading
{
    ...
    public abstract class List<TValue>
    {
        ...
        public static bool operator ==(List<TValue> list1, List<TValue> list2)
        {
            ...
            return list1.ToFlat().SequenceEqual(list2.ToFlat());
        }
        ...
        public static List<TValue> operator -(List<TValue> list1, List<TValue> list2)
        {
            IEnumerable<TValue> flattenedList2 = list2.ToFlat();
            IEnumerable<TValue> removedElementsEnumerable = list1.ToFlat().Where(elem => !flattenedList2.Contains(elem));
            return List.From(removedElementsEnumerable);
        }
